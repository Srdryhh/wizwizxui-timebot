...
",
    ...
    'buy_account_cart_to_cart'=>"♻️ عزیزم یه تصویر از فیش واریزی برام ارسال کن :

🔰 <code>ACCOUNT-NUMBER</code> - HOLDER-NAME

✅ بعد از اینکه پرداختت تایید شد ( لینک سرور ) به صورت خودکار از طریق همین ربات برات ارسال میشه!",
    'renew_ccount_cart_to_cart'=>"♻️ عزیزم یه تصویر از فیش واریزی برام ارسال کن :
...
",
    ...
    'start_message'=>'سلااام به باکسر ربات خوش اومدی 🫡🌸
    
 اولویت برای ما سرعت و پایداری سرویس هاست ❤️

✅ دسته بندی بر اساس اپراتور و نوع استفاده
📡 متمرکز بر جدیدترین متد های فیلترین ایران 
☎️ پشتیبانی تا روز آخر 

t.me/Boxerrobot_Channel کانال اطلاع رسانی باکسرربات
t.me/srdryho آیدی پشتیبانی
